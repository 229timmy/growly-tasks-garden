...
export default function PrivacyPolicy() {
  const schema = {
    ...
    "@type": "WebPage",
    "name": "Privacy Policy - Yield GT",
    "description": "Learn about how Yield GT collects, uses, and protects your personal information.",
    "publisher": {
      "@type": "Organization",
      "name": "Yield GT"
    }
  ...
  return (
    <>
      <SEO
        title="Privacy Policy - Yield GT"
        description="Learn about how Yield GT collects, uses, and protects your personal information. We are committed to maintaining the trust and confidence of our users."
        canonical="/privacy"
        type="article"
        schema={schema}
      />
